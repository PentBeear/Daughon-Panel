...
//actions.get("mqtt", "mqtt:broker:9882e1ef27").publishMQTT("cmnd/tasmota_bedroom_nspanel/nextion", daughon.actions.panelActions.wake() ,false);  
  actions.get("mqtt", "mqtt:broker:9882e1ef27").publishMQTT("cmnd/tasmota_bedroom_nspanel/nextion", daughon.actions.panelActions.vis(3,1) ,false);  
}
