...
function wrapper(){
  ...
  daughon.main.runPanel(jsonObject,messageHandler,people,pageHandler,pages,indicatorHandler,buttonHandler,definedActions,submenuHandler,submenus);
